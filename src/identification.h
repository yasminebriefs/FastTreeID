...
IdentificationResult identify (const std::vector<std::pair<size_t, size_t>> &bidirected, const std::vector<size_t> &directed, std::optional<uint64_t> seed, std::optional<int64_t> prime);
